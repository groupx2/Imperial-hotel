...
app.controller('addLoginController',function($scope,$http,$cookies){
...
app.controller('addSignUpController',function($scope,$http,$log){
...
app.controller('addForgotPasswordController',function($scope,$http,$log){
